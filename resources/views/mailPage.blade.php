                    ...
                    <div class="header__menu menu mail-header__menu">
                        <nav class="header__menu-nav menu-nav">
                            <ul class="header__menu-list menu-list">
                                ...
                                <li class="header__menu-item menu-item">
                                    <a href="#popup2" class="header__menu-link menu-link popup-link" onclick="openPopup2()">Оставить заявку</a>
                                </li>
                                <li class="header__menu-item menu-item">
        ...
        <div class="mail-header-wrapper">
            <div class="mail-header-content d-flex justify-content-between">
                <div class="first-content-mail">
                    ...
                    <form action="#" class="first-screen__form form-first-screen form">
                        <div class="form__items" style="height: auto;">
                            <a href="#popup2" class="form-first-screen__buttonform__button button header__menu-link menu-link popup-link" 
                            style="text-align: center; color: black; background-color: #FFD704; font-weight: bold;" onclick="openPopup2()">Оставить заявку</a>
                        </div>
                    </form>
                </div>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="item-accordion">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div>
                                Необходимо связаться с поставщиком и указать верный адрес склада. Если поставщик не может изменить адрес доставки, необходимо совершить возврат и после заказать на верный адрес.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item-accordion">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div>
                                Скорее всего, ваша посылка еще не отправлена. Свяжитесь с поставщиком для уточнения трек-номера вашего отправления.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item-accordion">
                        <div class="header-item-accordion" id="headingThree">
                            <b class="mb-0 d-flex justify-between">
                                <button class="btn btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    Если вы сделали ошибку в анкете?
                                    <img class="plus-accordion" src="{{asset('/img/plus.png')}}" alt="plus">
                                    <img class="close-accordion" src="{{asset('/img/close-accordion.png')}}" alt="plus">
                                </button>
                            </b>
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                            <div>
                                Менеджер свяжется с вами перед отправкой посылки и уточнит правильность данных.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item-accordion">
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                            <div>
                                Значит, посылка еще не поступила к нам на склад. После оформления посылки у нас на складе, наш менеджер свяжется с вами для уточнения данных и оплаты.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item-accordion">
                        <div class="header-item-accordion" id="headingFive">
                            <b class="mb-0 d-flex justify-between">
                                <button class="btn btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                    Если вы оставили заявку, но потом передумали?
                                    <img class="plus-accordion" src="{{asset('/img/plus.png')}}" alt="plus">
                                    <img class="close-accordion" src="{{asset('/img/close-accordion.png')}}" alt="plus">
                                </button>
                            </b>
                        ...
                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                            <div>
                                Если посылка не поступит в течение 60 дней, заказ удалится автоматически. Если груз поступит - менеджер свяжется с вами и вы сможете сообщить ему, что передумали отправлять груз.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item-accordion">
                        ...
                        <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                            <div>
                                При поступлении посылки на наш склад, с вами свяжется наш менеджер для подтверждения данных и оплаты. Ваш груз отправится в Россию после оплаты.
                            </div>
                        </div>
                    </div>

                    <div class="item-accordion">
                        <div class="header-item-accordion" id="headingSeven">
                            <b class="mb-0 d-flex justify-between">
                        ...
                        <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
                            <div>
                                В случае, если вашу посылку потеряют во время доставки, вам вернут 100% заявленной стоимости посылки и доставки.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="footer__menu menu">
                        <nav class="footer__menu-nav">
                            <ul class="footer__menu-list menu-list">
                                ...
                                <li class="footer__menu-item menu-item">
                                    <a href="#popup2" class="footer__menu-link menu-link" onclick="openPopup2()">Оставить заявку</a>
                                </li>
                                <li class="footer__menu-item menu-item">
